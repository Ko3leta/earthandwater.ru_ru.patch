...
public interface ProjectileItem {
    ...
    public static class Settings {
        ...
        public Settings(PositionFunction positionFunction, float uncertainty, float power, OptionalInt overrideDispenseEvent) {
        ...
        public static class Builder {
            private PositionFunction positionFunction = (pointer, direction) -> {
                return DispenserBlock.getOutputLocation(pointer);
            };
