...
public class EarthChargeProjectileModel extends EntityModel<EarthChargeProjectileRenderState> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData bb_main = modelPartData.addChild("earth_charge", ModelPartBuilder.create().uv(0, 0).cuboid(-2.0F, -4.0F, -2.0F, 4.0F, 4.0F, 4.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 24.0F, 0.0F));
